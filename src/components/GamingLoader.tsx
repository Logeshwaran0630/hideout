...
const gamingTips = [
  ...
  "Pro tip: Book Duo sessions to get the best value with a friend!",
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4">
      <div className="relative w-32 h-32 mb-6">
        <div className="absolute inset-0 rounded-full border-4 border-[#2A2F38]" />
        <div className="absolute inset-0 rounded-full border-4 border-t-[#FF4500] border-r-[#22C55E] border-b-[#FF5722] border-l-transparent joystick-spin" />

        <div className="absolute inset-0 flex items-center justify-center">
          {frame === 0 && (
            <svg className="w-12 h-12 text-[#FF4500]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {frame === 2 && (
            <svg className="w-12 h-12 text-[#FF5722]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <p className="text-[#FF4500] font-medium text-lg mb-2 animate-pulse-text">{randomTips[randomTipIndex]}</p>

      <div className="mt-4 max-w-md text-center">
        <div className="bg-[#14181F] border border-[#FF4500]/20 rounded-xl p-4">
          <p className="text-xs text-[#A0A6AF] mb-1">GAMING TIP</p>
