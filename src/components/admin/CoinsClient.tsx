...
export default function CoinsClient({ ledger, totalEarned, totalRedeemed }: { ledger: LedgerRow[]; totalEarned: number; totalRedeemed: number; }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <div className="text-[12px] font-medium uppercase tracking-[0.15em] text-[#ff5200]">LEDGER</div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-[#2A2F38] bg-[#14181F] p-6">
          ...
          <div className="mt-3 font-heading text-[40px] uppercase text-[#ff5200]">{totalEarned}</div>
        </div>
        <div className="rounded-xl border border-[#2A2F38] bg-[#14181F] p-6">
