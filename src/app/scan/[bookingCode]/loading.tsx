    ...
    <div className="min-h-screen bg-[#0A0F18] px-6 py-20 text-white">
      <div className="mx-auto flex max-w-2xl flex-col gap-8">
        <div className="text-center">
          <div className="mx-auto mb-4 h-20 w-20 animate-pulse rounded-full bg-[#FF4500]/20" />
        ...
        <div className="overflow-hidden rounded-2xl border border-[#2A2F38] bg-[#14181F]">
          <div className="h-20 animate-pulse bg-gradient-to-r from-[#FF4500]/40 to-[#FF4500]/40" />
