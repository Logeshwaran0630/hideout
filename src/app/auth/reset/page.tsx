        ...
        <form onSubmit={handleReset} className="mt-6">
          ...
          <div className="mt-6 space-y-4">
            <label className="block text-sm text-[#FAFAFA] relative">
              ...
              <input value={password} onChange={(e) => setPassword(e.target.value)} type={showPassword ? 'text' : 'password'} placeholder="New password" className="w-full rounded-md bg-[#09090B] border border-[#27272A] px-4 py-3 text-[#FAFAFA] placeholder:text-[#71717A] focus:border-[#FF3A3A] outline-none" />
            ...
            <label className="block text-sm text-[#FAFAFA]">
              ...
              <input value={confirm} onChange={(e) => setConfirm(e.target.value)} type={showPassword ? 'text' : 'password'} placeholder="Confirm password" className={`w-full rounded-md bg-[#09090B] border ${confirm && confirm !== password ? 'border-[#EF4444]' : confirm ? 'border-[#4ADE80]' : 'border-[#27272A]'} px-4 py-3 text-[#FAFAFA] placeholder:text-[#71717A] focus:border-[#FF3A3A] outline-none`} />
            ...
            <button type="submit" disabled={loading} className="w-full rounded-md bg-[#FF3A3A] px-4 py-3 text-sm font-semibold text-[#09090B] disabled:opacity-60">
