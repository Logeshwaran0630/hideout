  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0A0F18] flex items-center justify-center px-6 py-12">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md card-premium rounded-xl border border-[#2A2F38] bg-[#14181F]/80 backdrop-blur-sm p-10"
      >
        {/* Logo */}
        <div className="flex flex-col items-center">
          <div className="rounded-xl border border-[#2A2F38] bg-[#0A0F18]/60 px-6 py-3 backdrop-blur-sm">
            <Image
              src="/logo.png"
              alt="The Hideout"
              width={160}
        ...
        {/* Tab switcher */}
        <div className="mt-6">
          <div className="flex gap-2 rounded-lg bg-[#0A0F18] border border-[#2A2F38] p-1">
            <button
          ...
          {!resetView ? (
            tab === "signin" ? (
              ...
              >
                ...
                <p className="text-sm text-[#A0A6AF] text-center mt-2">
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-10 text-[#A0A6AF] hover:text-white transition"
                    >
              ...
              >
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-2 h-1.5 w-full rounded bg-[#2A2F38]">
                      <div
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full rounded-lg bg-[#0A0F18] border ${
              ...
              <div className="mt-6 space-y-4">
                ...
                {resetSent ? (
                  ...
                  <>
                    ...
                    <div className="text-sm text-[#A0A6AF] text-center">
                      <button
                        type="button"
