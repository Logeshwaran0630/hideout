  ...
  return (
    <div className="min-h-screen bg-[#0A0F18] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        <Gamepad2 className="mx-auto mb-6 h-20 w-20 text-[#FF4500]" />
        <h1 className="text-6xl font-black text-[#FF4500] mb-4">404</h1>
        ...
        <div className="mt-8 text-sm text-[#A0A6AF]">
          Need help?{" "}
          <a href="https://wa.me/919876543210" className="text-[#FF4500] hover:underline">
            Chat with us
          </a>
        </div>
      </div>
